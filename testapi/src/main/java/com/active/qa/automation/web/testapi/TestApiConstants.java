...
public interface TestApiConstants {
    ...
    public static final int VERY_LONG_SLEEP = Integer.parseInt(TestProperty.getProperty("page.loading.wait.extralong"));
    public static final int LONG_SLEEP = Integer.parseInt(TestProperty.getProperty("page.loading.wait.long"));
    public static final int SLEEP = Integer.parseInt(TestProperty.getProperty("page.loading.wait"));
    public static final int SHORT_SLEEP = Integer.parseInt(TestProperty.getProperty("page.loading.wait.short"));
    public static final int VERY_SHORT_SLEEP = Integer.parseInt(TestProperty.getProperty("page.loading.wait.extrashort"));
    public static final int PAGELOADING_SYNC_TIME = Integer.parseInt(TestProperty.getProperty("page.loading.sync"));
    public static final int FILE_DIALOG_LONG_SLEEP = Integer.parseInt(TestProperty.getProperty("dialog.loading.wait.extralong"));
