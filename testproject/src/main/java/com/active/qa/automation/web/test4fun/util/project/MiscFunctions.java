...
public class MiscFunctions {
  ...
  private static String commonConvertTypeCode(String category, String from) {
    ...
    if (category.equals("EFT Type")) {
      typeStr = new String[]{TestConstants.EFT_TYPE_NOEFT, TestConstants.EFT_TYPE_EFT, TestConstants.EFT_TYPE_EDI};
      typeCode = new String[]{TestConstants.EFT_TYPE_NOEFT_CODE, TestConstants.EFT_TYPE_EFT_CODE, TestConstants.EFT_TYPE_EDI_CODE};
    } else if (category.equals("EFT Invoice Status")) {
      typeStr = new String[]{TestConstants.EFT_INVOICE_STATUS_PENDING, TestConstants.EFT_INVOICE_STATUS_SENT,
          TestConstants.EFT_INVOICE_STATUS_CLEARED, TestConstants.EFT_INVOICE_STATUS_FAILED,
          TestConstants.EFT_INVOICE_STATUS_GENERATED, TestConstants.EFT_INVOICE_STATUS_PAID};
      typeCode = new String[]{TestConstants.EFT_INVOICE_STATUS_PENDING_CODE, TestConstants.EFT_INVOICE_STATUS_SENT_CODE,
          TestConstants.EFT_INVOICE_STATUS_CLEARED_CODE, TestConstants.EFT_INVOICE_STATUS_FAILED_CODE,
          TestConstants.EFT_INVOICE_STATUS_GENERATED_CODE, TestConstants.EFT_INVOICE_STATUS_PAID_CODE};
    } else if (category.equals("EFT Invoice Transaction Type")) {
      typeStr = new String[]{TestConstants.EFT_TRANS_TYPE_NAME_CREATE, TestConstants.EFT_TRANS_TYPE_NAME_CLEAR,
          TestConstants.EFT_TRANS_TYPE_NAME_TRANSMIT, TestConstants.EFT_TRANS_TYPE_NAME_APPLY,
          TestConstants.EFT_TRANS_TYPE_NAME_MARK_AS_PAID, TestConstants.EFT_TRANS_TYPE_NAME_PROCESS_RETURNED};
      typeCode = new String[]{TestConstants.EFT_TRANS_TYPE_NAME_CREATE_CODE, TestConstants.EFT_TRANS_TYPE_NAME_CLEAR_CODE,
          TestConstants.EFT_TRANS_TYPE_NAME_TRANSMIT_CODE, TestConstants.EFT_TRANS_TYPE_NAME_APPLY_CODE,
          TestConstants.EFT_TRANS_TYPE_NAME_MARK_AS_PAID_CODE, TestConstants.EFT_TRANS_TYPE_NAME_PROCESS_RETURNED_CODE};
    } else if (category.equals("Fee Journal Type")) {
      typeStr = new String[]{TestConstants.JOURNALTYPE_DEBIT, TestConstants.JOURNALTYPE_CREDIT};
      typeCode = new String[]{TestConstants.JOURNALTYPE_DEBIT_CODE, TestConstants.JOURNALTYPE_CREDIT_CODE};
    } else if (category.equals("Fee Status")) {
      typeStr = new String[]{TestConstants.FEESTATUS_REVERSED, TestConstants.FEESTATUS_PRICED, TestConstants.FEESTATUS_PENDING, TestConstants.FEESTATUS_VOID};
      typeCode = new String[]{TestConstants.FEESTATUS_REVERSED_CODE, TestConstants.FEESTATUS_PRICED_CODE, TestConstants.FEESTATUS_PENDING_CODE, TestConstants.FEESTATUS_VOID_CODE};
    } else if (category.equals("Attribute")) {
      typeStr = new String[]{TestConstants.ATTRIBUT_ENFORCEMINIMUMTOCONFIRMRULEINFIELD_NAME};
      typeCode = new String[]{TestConstants.ATTRIBUT_ENFORCEMINIMUMTOCONFIRMRULEINFIELD_CODE};
  ...
  public static String getRemittanceStatusCode(String status) {
    if (status.equals(TestConstants.REMITTANCE_PENDING)) {
      return TestConstants.REMITTANCE_PENDING_CODE;
    } else if (status.equals(TestConstants.REMITTANCE_SENT)) {
      return TestConstants.REMITTANCE_SENT_CODE;
    } else if (status.equals(TestConstants.REMITTANCE_CLEAR)) {
      return TestConstants.REMITTANCE_CLEAR_CODE;
    } else if (status.equals(TestConstants.REMITTANCE_FAIL)) {
      return TestConstants.REMITTANCE_FAIL_CODE;
    } else {
